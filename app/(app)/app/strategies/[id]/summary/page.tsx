  ...
  return (
    <div>
      <div className="flex flex-col space-y-4 items-center">
        {/* <h1 className="text-4xl font-bold pb-4 tracking-wider">
          Performance Summary
        </h1>
        <h1 className="text-3xl pb-16">{strategy.name}</h1> */}
        <p className="mt-4">Performance Summary (Created {strategy.createdAt.toDate().toLocaleString()})</p>
          ...
          <div className="space-y-1 w-1/2 items-center">
            <div className="flex">
              ...
              <p className="w-1/2">
                {formatValue(
                  "Total Net Profit",
                  strategy.metrics["Total Net Profit"]
                )}
              </p>
            </div>
            <div className="flex">
              ...
              <p className="w-1/2">
                {formatValue("Gross Profit", strategy.metrics["Gross Profit"])}
              </p>
            </div>
            <div className="flex">
              <p className="w-1/2">Gross Loss: </p>
              <p className="w-1/2">
                {formatValue("Gross Loss", strategy.metrics["Gross Loss"])}
              </p>
            </div>
            <div className="flex">
              ...
              <p className="w-1/2">
                {formatValue(
                  "Profit Factor",
                  strategy.metrics["Profit Factor"]
                )}
              </p>
            </div>
            <div className="flex">
              ...
              <p className="w-1/2">
                {formatValue("Total Trades", strategy.metrics["Total Trades"])}
              </p>
            </div>
            <div className="flex">
              ...
              <p className="w-1/2">
                {formatValue(
                  "Winning Trades",
                  strategy.metrics["Winning Trades"]
                )}
              </p>
            </div>
            <div className="flex">
              ...
              <p className="w-1/2">
                {formatValue(
                  "Losing Trades",
                  strategy.metrics["Losing Trades"]
                )}
              </p>
            </div>
            <div className="flex">
              ...
              <p className="w-1/2">
                {formatValue("Even Trades", strategy.metrics["Even Trades"])}
              </p>
            </div>
            <div className="flex">
              <p className="w-1/2">% Profitable: </p>
              <p className="w-1/2">
                {formatValue("% Profitable", strategy.metrics["% Profitable"])}
              </p>
            </div>
            <div className="flex pt-10">
              ...
              <p className="w-1/2">
                {formatValue(
                  "Avg. Trade Net Profit",
                  strategy.metrics["Avg. Trade Net Profit"]
                )}
              </p>
            </div>
            <div className="flex">
              ...
              <p className="w-1/2">
                {formatValue(
                  "Avg. Winning Trade",
                  strategy.metrics["Avg. Winning Trade"]
                )}
              </p>
            </div>
            <div className="flex">
              ...
              <p className="w-1/2">
                {formatValue(
                  "Avg. Losing Trade",
                  strategy.metrics["Avg. Losing Trade"]
                )}
              </p>
            </div>
            <div className="flex">
              ...
              <p className="w-1/2">
                {formatValue(
                  "Ratio Avg Win:Avg Loss",
                  strategy.metrics["Ratio Avg Win:Avg Loss"]
                )}
              </p>
            </div>
            <div className="flex pt-10">
              ...
              <p className="w-1/2">
                {formatValue("Largest Win", strategy.metrics["Largest Win"])}
              </p>
            </div>
            <div className="flex">
              <p className=" w-1/2">Largest Loss: </p>
              <p className="w-1/2">
                {formatValue("Largest Loss", strategy.metrics["Largest Loss"])}
              </p>
            </div>
            <div className="flex">
              ...
              <p className="w-1/2">
                {formatValue(
                  ...
                  strategy.metrics["Max Consecutive Wins"]
                )}
              </p>
            </div>
            <div className="flex">
              ...
              <p className="w-1/2">
                {formatValue(
                  ...
                  strategy.metrics["Max Consecutive Losses"]
                )}
              </p>
            </div>
            <div className="flex pt-10">
              ...
              <p className="w-1/2">
                {formatValue(
                  "Trading Period",
                  strategy.metrics["Trading Period"]
                )}
              </p>
            </div>
            <div className="flex">
              ...
              <p className="w-1/2">
                {formatValue(
                  "Total Trading Days",
                  strategy.metrics["Total Trading Days"]
                )}
              </p>
            </div>
            <div className="flex">
              ...
              <p className="w-1/2">
                {formatValue(
                  "Longest Flat Period",
                  strategy.metrics["Longest Flat Period"]
                )}
              </p>
            </div>
            <div className="flex pt-10">
              ...
              <p className="w-1/2">
                {formatValue(
                  "Max Futures Contracts",
                  strategy.metrics["Max Futures Contracts"]
                )}
              </p>
            </div>
            <div className="flex">
              ...
              <p className="w-1/2">
                {formatValue(
                  "Max Forex Contracts",
                  strategy.metrics["Max Forex Contracts"]
                )}
              </p>
            </div>
            <div className="flex">
              ...
              <p className="w-1/2">
                {formatValue("Max Shares", strategy.metrics["Max Shares"])}
              </p>
            </div>
          </div>
          <div className="space-y-1 w-1/2 items-center">
            ...
            <div className="flex">
              ...
              <p className="w-1/2">
                {formatValue(
                  "Total Net Profit",
                  strategy.metrics["Total Net Profi"]
                )}
              </p>
            </div>
            <div className="flex">
              ...
              <p className="w-1/2">
                {formatValue("Max Drawdo", strategy.metrics["Max Drawwn %"])}
              </p>
            </div>
            <div className="flex">
              ...
              <p className="w-1/2">
                {formatValue(
                  "Total Net Profit",
                  strategy.metrics["Total Net Proit"]
                )}
              </p>
            </div>
            <div className="flex">
              ...
              <p className="w-1/2">
                {formatValue(
                  "Longest Drawdown",
                  strategy.metrics["Longest Drawdown"]
                )}
              </p>
            </div>
            <div className="flex">
              ...
              <p className="w-1/2">
                {formatValue(
                  "Recovery Factor",
                  strategy.metrics["Recovery Factor"]
                )}
              </p>
            </div>
            <div className="flex">
            ...
            <div className="flex pt-10">
              ...
              <p className="w-1/2">
                {formatValue("Max Runup", strategy.metrics["Max Runup"])}
              </p>
            </div>
            <div className="flex">
              <p className="w-1/2">As % of Initial Equity: </p>
              <p className="w-1/2">
                {formatValue(
                  "Total Net Profit",
                  strategy.metrics["Total Net Prfit"]
                )}
              </p>
            </div>
            <div className="flex">
            ...
            <div className="flex">
              ...
              <p className="w-1/2">
                {formatValue(
                  "Longest Runup",
                  strategy.metrics["Longest Runup"]
                )}
              </p>
            </div>
            <div className="flex pt-10">
              ...
              <p className="w-1/2">
                {formatValue(
                  "Initial Capital",
                  strategy.metrics["Initial Capital"]
                )}
              </p>
            </div>
            <div className="flex">
              ...
              <p className="w-1/2">
                {formatValue(
                  "Initial Ctial",
                  strategy.metrics["Initial Ctial"]
                )}
              </p>
            </div>
            <div className="flex">
              ...
              <p className="w-1/2">
                {formatValue(
                  "Return on Initial Capital",
                  strategy.metrics["Return on Initial Capital"]
                )}
              </p>
            </div>
            <div className="flex">
              ...
              <p className="w-1/2">
                {formatValue(
                  "Annual Rate of Return",
                  strategy.metrics["Annual Rate of Return"]
                )}
              </p>
            </div>
            <div className="flex">
              ...
              <p className="w-1/2">
                {formatValue(
                  "Avg. Monthly Return",
                  strategy.metrics["Avg. Monthly Return"]
                )}
              </p>
            </div>
            <div className="flex">
              ...
              <p className="w-1/2">
                {formatValue(
                  "Std. Deviation of Monthly Return",
                  strategy.metrics["Std. Deviation of Monthly Return"]
                )}
              </p>
            </div>
            <div className="flex">
              ...
              <p className="w-1/2">
                {formatValue(
                  "% Profitable Months",
                  strategy.metrics["% Profitable Months"]
                )}
              </p>
            </div>
            <div className="flex pt-10">
              ...
              <p className="w-1/2">
                {formatValue("Sharpe Ratio", strategy.metrics["Sharpe Ratio"])}
              </p>
            </div>
            <div className="flex">
              ...
              <p className="w-1/2">
                {formatValue(
                  "Sortino Ratio",
                  strategy.metrics["Sortino Ratio"]
                )}
              </p>
            </div>
            <div className="flex">
              ...
              <p className="w-1/2">
                {formatValue(
                  "Sterling Ratio",
                  strategy.metrics["Sterling Ratio"]
                )}
              </p>
            </div>
            <div className="flex">
              ...
              <p className="w-1/2">
                {formatValue("MAR Ratio", strategy.metrics["MAR Ratio"])}
              </p>
            </div>
            <div className="flex">
              ...
              <p className="w-1/2">
                {formatValue(
                  "Efficiency Factor",
                  strategy.metrics["Efficiency Factor"]
                )}
              </p>
            </div>
            <div className="flex">
              ...
              <p className="w-1/2">
                {formatValue(
                  "Total Commission",
                  strategy.metrics["Total Commission"]
                )}
              </p>
            </div>
            <div className="flex">
              ...
              <p className="w-1/2">
                {formatValue(
                  "Total Slippage",
                  strategy.metrics["Total Slippage"]
                )}
              </p>
            </div>
          </div>
